...
contract DegenToken is ERC20, Ownable, ERC20Burnable {
    ...
    function showStoreItems() external pure returns (string memory) {
        ...
        console.log("Selection 2. Degen Crypto Art Print");
        console.log("Selection 3. Degen Collector's Card Set");
    ...
    function redeemTokens(uint8 _userChoice) external payable returns (bool) {
        if (_userChoice == 1) {
            ...
            console.log("You have redeemed for an official Degen Crypto Art Print!");
            return true;
        }
            ...
            console.log("You have redeemed for Collector's Card Set our Degen Discord!");
            return true;
        }
        else {
